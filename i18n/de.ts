export default {
  ...
  'cameraEvents.topBar.retained.title': 'Gespeicherte Ereignisse',
  ...
  'cameraEvents.action.retain': 'Ereignis speichern',
  'cameraEvents.action.unretain': 'Aus gespeicherten Ereignissen entfernen',
  'cameraEvents.action.retainHint':
    'Behält das Ereignis dauerhaft auf dem Frigate-Server',
  'cameraEvents.action.unretainHint':
    'Das Ereignis kann wieder regulär durch Frigate gelöscht werden',
