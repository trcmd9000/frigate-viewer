...
- Next release candidate version name: `18.0.14`
- Next release candidate version code: `39`
...
2. Confirm that `versionCode` 39 has not already been uploaded; otherwise
